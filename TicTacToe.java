...
public class TicTacToe implements ActionListener{
     ...
     */
    //Creating Frame
    JFrame f = new JFrame("Diksha's Tic Tac Toe Game");

    //Creating Label for displaying the winner.
    Label lbl = new Label(" ");
    ...
    public void actionPerformed(ActionEvent a){
        ...
        //Calling checkWinner() method for checking who the winner is
        checkWinner();
    }
    ...
    private void initUI() {
        ...
        //panel layout for printing winner 
        ...
        //adding all buttons to board layout
        board.add(btn1);
        board.add(btn2);
        board.add(btn3);
        board.add(btn4);
    ...
    public void addActionEvents() {
        ...
        //adding action listener on buttons click
    ...
    private void checkWinner(){
        ...
        //check vertically
                ...
                && btn4.getText() == btn7.getText() && btn1.getText() != "" && btn4.getText() != "" && btn7.getText() != ""){
            win = true;
        } 
        else if(btn2.getText() == btn5.getText()
                && btn5.getText() == btn8.getText() && btn2.getText() != "" && btn5.getText() != "" && btn8.getText() != "") {
            win = true;
        } 
        ...
        if(win){
            lbl.setText("Yaayy! player " + letter + " won the game!");
            btn1.setEnabled(false);
            btn2.setEnabled(false);
            btn3.setEnabled(false);
            btn4.setEnabled(false);
            ...
            lbl.setText("ahh! The game ended in a tie.");
            btn1.setEnabled(false);
            btn2.setEnabled(false);
            btn3.setEnabled(false);
            btn4.setEnabled(false);
